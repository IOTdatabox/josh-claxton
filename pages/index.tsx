...
export default function Home() {
  ...
  const meta = {
    title: "Josh Claxton - Full Stack Developer",
    description: `a proven history of architecting, developing, and deploying full-featured web applications that focus on user experience and performant back-end design`,
    image: "/Me_.png",
    type: "website",
  };
  ...
  return (
    <>
      <Head>
        ...
        <meta name="twitter:site" content="@joshclaxtonlean" />
