...
const ClickableIcon = (props:Props) => {
  return (
    <a href={props.href} className="" target={"_blank"} rel="noreferrer">
      <props.Icon
        className={
          "w-5 h-5 text-gray-300 hover:text-AAsecondary transition duration-800 fill-current hover:cursor-pointer "
        }
      />
    </a>
  );
  ...
  return (
      <div className={` ${props.className} bg-AAprimary flex flex-col justify-center items-center py-8 space-y-4 `}>
        ...
        <div className="flex flex-row space-x-8">
          <ClickableIcon
            href={"https://github.com/joshclaxtonlean"}
            Icon={GithubIcon}
          />
          <ClickableIcon
            href={"https://www.linkedin.com/in/josh-claxton-lean/"}
            Icon={LinkedinIcon}
          />
          <ClickableIcon
            href={"https://www.instagram.com/josh-claxton-lean/"}
            Icon={InstagramIcon}
          />
          <ClickableIcon
            href={"https://www.youtube.com/c/josh-claxton-lean"}
            Icon={YoutubeIcon}
          />
        </div>
    ...
    text-sm  space-y-2  "
          >
            <span className="group-hover:text-AAsecondary sm:text-sm text-xs">
              Designed & Built by Josh Claxton
            </span>

            <span className="text-xs flex flex-row items-center space-x-2 group-hover:text-AAsecondary">
              <GithubIcon
                className={
                  "w-4 h-4 text-gray-300 fill-current group-hover:text-AAsecondary duration-800"
                }
              />
