...
import Productiv from "./Descriptions/Productiv";
import QTS from "./Descriptions/QTS";
import Paypal from "./Descriptions/Paypal";
import Powerschool from "./Descriptions/Powerschool";
export default function WhereIHaveWorked() {
  ...
  const [DescriptionJob, setDescriptionJob] = React.useState("PRODUCTIV");
  return (
  ...
  const CompanyButton = props => {
    return (
      <button
        ...
        className={`flex-none text-sub text-center md:text-left  hover:text-AAsecondary
             hover:bg-ResumeButtonHover rounded  font-mono  
             py-3 md:pl-6 md:px-4 md:w-300 w-300 duration-500
