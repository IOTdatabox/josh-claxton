    ...
    <div className="relative snap-mandatory min-h-screen bg-AAprimary w-full flex justify-center items-center">
      <section className="bg-white bg-transparent">
        <div className="py-8 px-4 mx-auto max-w-screen-md text-center lg:py-16 lg:px-12">
          ...
          <p className="font-light text-gray-500 md:text-lg xl:text-xl dark:text-gray-300">
            Sorry! the administrator is performing scheduled maintenance.
          </p>
          <p className="font-light text-white-500 md:text-lg xl:text-xl dark:text-gray-300">
            No problem contact me on{" "}
            <a
              className="text-white underline"
              href="mailto:jclaxton.lean@gmail.com?subject=Hello%20World&body=Body%20of%20the%20email"
            >
              jclaxton.lean@gmail.com
            </a>
          </p>
        </div>
      </section>
